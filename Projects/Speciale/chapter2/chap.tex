...
\end{align*}
for all $\chi \in \hat G$ and $t \in G$. Define isomorphism $\Phi \colon \cc(G \times \hat G, A) \to \cc(\hat G\times G , A)$ by
\begin{align*}
	
\end{align*}

Note that for $\sigma, \chi \in \hat G$ and $s,t \in G$ we have
\begin{align*}
