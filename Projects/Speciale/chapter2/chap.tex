...
We introduce a topology on $B_+^1(A \rtimes_\alpha G)$, which extends the topology of uniform convergence on compacta of $G$ for when $A = \C$ and the action is the trivial one:
\begin{definition}
