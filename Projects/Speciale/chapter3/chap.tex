...
\begin{proof}
	...
	finishing the proof.
\end{proof}
This gives us the first ingredient in determining the ideal structure of $A \rtimes_\alpha G$:
\begin{corollary}
...
\end{proof}
\begin{definition}
	\todo{include Prime $A$ in prelim} Let $G \acts \alpha A$. We say that $A$ is \myemph{$G$-prime} if whenever $I,J$ are non-zero $G$-invariant ideals in $A$ it holds that $I \cap J \neq 0$.
\end{definition}
\begin{remark}
