...
\end{proposition}
For a proof, see \cite[Proposition 7.6, 7.7]{breuillard2017c}. 
...
\begin{theorem}
	...
	\begin{enumerate}
		...
		\item If $G \acts \alpha A$ with $A$ unital, then $A \rtimes_{\alpha,r} G$ is simple whenever $G$-simple.
	\end{enumerate}
	\label{breulcsimple}
\end{theorem}
\begin{corollary}
