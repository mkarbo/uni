...
\begin{proposition}
	The algebra $\mathcal{L}(E)$ is a closed $*$-subalgebra of $\mathbb{B}(E,E)$ such that for $t \in \mathcal{L}(E)$ we have
	\begin{align*}
		\lv t^*t\rv = \lv t \rv^2,
	\end{align*}
...
\end{proposition}
\begin{proof}
	Since $\mathbb{B}(E,E)$ is a Banach algebra, we have $\lv t^*t\rv \leq \lv t^*\rv \lv t\rv$ for all $t \in \mathcal{L}(E)$. Moreover, by Cauchy-Schwarz, we have
	\begin{align*}
